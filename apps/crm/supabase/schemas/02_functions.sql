...
-- Fusionar dos empresas: lo que apunta a la perdedora pasa a la ganadora,
-- la ficha se combina y la perdedora se elimina (la llama
-- /api/empresas/fusionar; ver la migración 20260918220000).
