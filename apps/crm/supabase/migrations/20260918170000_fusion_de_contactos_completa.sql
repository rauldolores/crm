-- Fusionar contactos ya no destruye historia: al borrar al contacto
-- perdedor, las claves foráneas en cascada se llevaban sus tickets, su
-- perfil de afiliado y sus correos en cola, y dejaban sus cotizaciones sin
-- contacto. Ahora todo eso pasa al contacto ganador antes del borrado (el
-- afiliado solo si el ganador no tiene ya uno). Misma corrección en la
-- edge function merge_contacts, que es la que usa la aplicación; esta
-- función la usa el servidor MCP.
