      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            ...
            "Tabla o tablero: arriba a la derecha de la lista se cambia a un tablero por estado; arrastrar una tarjeta a otra columna cambia el estado (a «Cerrado» pide el motivo). Respeta los mismos filtros y se recuerda la vista elegida.",
            "La ficha muestra un solo hilo cronológico: notas, correos enviados al cliente y cambios de estado, prioridad, categoría o responsable, en orden.",
